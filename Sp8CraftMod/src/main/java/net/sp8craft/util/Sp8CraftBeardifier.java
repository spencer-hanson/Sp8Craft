...
public class Sp8CraftBeardifier implements DensityFunctions.BeardifierOrMarker {
    ...
    public Sp8CraftBeardifier(StructureFeatureManager pStructureFeatureManager, ChunkAccess pChunk) {
